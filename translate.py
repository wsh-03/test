        ...
        for dir, subdirs, files in os.walk(path2folder):      
            ...
            for file in files:
                ...
                if file.endswith(file_type):
                    ...
                    propmt = f"Translate the provided C file to Rust. The provided C file is {file} located in the {driver_name} directory in the Linux kernel. Please translate it from C to Rust and use corresponding FFIs generated by bindgen, for example use kernel::bindings::*, including only the Rust code without any comments. please also consider the use of unsafe code and the function name. {file_content}"
